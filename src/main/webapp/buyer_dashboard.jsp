...
%>
  <div class="hero_area">
                ...
                <div class="row">
                  <div class="col-md-7">
                    <div class="detail-box">
                      ...
                      <p>
                        Embark on a journey through our virtual bookstore. Sign in to explore a wide array of genres, from classic literature to contemporary bestsellers. Find the books that resonate with you and add them to your collection with just a few clicks.
                      </p>
                      
                      <%
                      	if(buyer_id != null)
                      	{
                      		out.println("<a href='buyer_books.jsp'>");
                      		out.println("Shop Now");
                      	}
                      	else
                      	{
                  ...
                  <div class="col-md-5 ">
                    <div class="img-box">
                      <img src="buyer/images/Daco_9306.png" alt="" />
                    </div>
                  </div>
                </div>
              </div>
    ...
    <div class="container">
      ...
      ArrayList<Seller_Books>  allbooks= s.getAllBooksDetailslimited();
    ...
    <div class="box">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-6">
            <div class="img-box">
              <img src="buyer/images/saving-img.png" alt="">
            </div>
          </div>
          <div class="col-lg-6">
            <div class="detail-box">
              ...
              <p>
                Wellcome to Book Market To Buy New And old Books With Ours Verified Sellers. And Buy The books With Maximum Discount.
              </p>
              <div class="btn-box">
                <a href="buyer_books.jsp" class="btn1">
                  Buy Now
                </a>
                <a href="buyer_about.jsp" class="btn2">
                  See More
                </a>
              </div>
            </div>
        ...
        <div class="col-md-4">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
                Enjoy complimentary delivery on qualifying orders within our covered areas
              </p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
                Experience free shipping for eligible orders within our designated regions
              </p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
                Uncompromising commitment to the finest quality in every product
              </p>
            </div>
          </div>
        </div>
